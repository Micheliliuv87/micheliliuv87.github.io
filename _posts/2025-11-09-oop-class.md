...
toc:
  - name: What is it?
  - name: Four Central Pillars
    subsections:
    - name: 1. Class and Object
    - name: 2. Encapsulation
    - name: 3. Inheritance
    - name: 4. Polymorphism
  - name: So Why OOP?
  - name: When to use OOP?
